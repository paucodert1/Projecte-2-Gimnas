    ...
    <body>
        ...
        <div class="main">
            ...
            <form class="form">
                        ...
                        <p type="Sexe:"><input type="text" value="<?php echo $_SESSION['sexe'] ?>" name="sexe"></input></p>
                        <p type="Data de naixement:"><input type="text" value="<?php echo $_SESSION['datanaixement'] ?>" name="datanaixement"></input></p>
                        <h2>DADES D' ACCÉS</h2>
                        <p type="Usuari:"><input type="text" value="<?php echo $_SESSION['username'] ?>" name="username"></input></p>
                        <p type="Contrasenya:"><input type="password" value="<?php echo md5($_SESSION['passwd']) ?>" name="passwd"></input></p>
                        <h2>DADES DE CONTACTE</h2>
                        <p type="Mobil:"><input type="text" value="<?php echo $_SESSION['telefon'] ?>" name="telefon"></input></p>
                        <p type="Correu:"><input type="text" value="<?php echo $_SESSION['email'] ?>" name="email"></input></p>
                        <h2>COMUNICACIO COMERCIAL</h2>
                        <p type="Comunicacio comercial:"><input type="text" value="<?php echo $_SESSION['comunicaciocomercial'] ?>" name="comunicaciocomercial" ></input></p>
                        <h2>COMPTE BANCARI</h2>
                        <p type="CCC:"><input value="<?php echo $_SESSION['ccc'] ?> "name="ccc"></input></p>
                        <button name="submit">Guardar dades</button>
                    <div>
                </div>
            </form>
        </div>
